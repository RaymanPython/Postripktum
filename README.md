        ...
        for y in range(self.height):
            for x in range(self.width):
                ...
                if self.color_matric[x][y] == 1:
                    self.zerol(screen, pygame.Color(255, 0, 0), x * self.cell_size + self.left + 1, y * self.cell_size + self.top + 1,
                               self.cell_size)
                elif self.color_matric[x][y] == 2:
                    self.zerol(screen, pygame.Color(0, 0, 255), x * self.cell_size + self.left + 1, y * self.cell_size + self.top + 1,
                               self.cell_size)
